...
public class SwaggerConfiguration {
    ...
    public Docket postsApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("usm-api")
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("User Management System")
                .description("User Management System for developers")
                .termsOfServiceUrl("")
